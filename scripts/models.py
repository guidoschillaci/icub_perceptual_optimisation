...
class Models:
    ...
    def loss_aux_wrapper(self, weight_visual_tensor, weight_proprio_tensor, weight_motor_tensor):
        ...
        def loss_aux(y_true, y_pred):
            ...
            true_out, true_aux_visual, true_aux_proprio, true_aux_motor = tf.split(y_true, axis=0)
            pred_out, pred_aux_visual, pred_aux_proprio, pred_aux_motor = tf.split(y_pred, axis=0)
